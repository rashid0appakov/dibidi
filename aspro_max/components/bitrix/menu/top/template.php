...
<? if ($arResult): ?>
    <? if (!function_exists('showSubItemss')) {
            ...
            if (is_array($arImg)):?>
                <div class="menu_img <?= $arParams['HAS_ICON'] ? 'icon' : '' ?>">
                    <a href="<?= $arParams['ITEM']["LINK"] ?>" class="noborder img_link colored_theme_svg">
                        ...
                        <? else:?>
                            <img class="lazy" src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arImg["src"]); ?>"
                                 data-src="<?= $arImg["src"] ?>" alt="<?= $arParams['ITEM']["TEXT"] ?>"
                                 title="<?= $arParams['ITEM']["TEXT"] ?>"/>
                        <? endif; ?>
                    </a>
                </div>
            <? endif; ?>
        ...
        <? endif; ?>
            <span
            class="name <?= $arParams['WIDE_MENU'] ? 'option-font-bold' : '' ?>"><?= $arParams['ITEM']["TEXT"] ?></span><?= ($arParams['ITEM']["CHILD"] && $arParams['SHOW_CHILDS'] ? CMax::showIconSvg("right light-ignore", SITE_TEMPLATE_PATH . '/images/svg/trianglearrow_right.svg', '', '') : '') ?>
            <? if ($arParams['ITEM']["LINK"]):?>
            </a>
        <? endif; ?>
            ...
            <ul class="dropdown-menu toggle_menu">
                ...
                <? if ($iCountChilds > $arParams['VISIBLE_ITEMS_MENU'] && $arParams['WIDE_MENU']):?>
                    <li>
                        <span class="colored_theme_hover_text more_items with_dropdown"><?= \Bitrix\Main\Localization\Loc::getMessage("S_MORE_ITEMS") . ' ' . ($iCountChilds - $arParams['VISIBLE_ITEMS_MENU']); ?></span>
                    </li>
                <? endif; ?>
            </ul>
        <? endif; ?>
                    ...
                    <td class="menu-item unvisible <?= ($arItem["CHILD"] ? "dropdown" : "") ?> <?= (isset($arItem["PARAMS"]["CLASS"]) ? $arItem["PARAMS"]["CLASS"] : ""); ?>  <?= ($arItem["SELECTED"] ? "active" : "") ?>">
                        <div class="wrap">
                            <a class="<?= ($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "") ?>"
                               href="<?= $arItem["LINK"] ?>" style="background-image:url('<?= $arImg["src"] ?>');">
                                <div>
                                                ...
                                                <div class="menu-navigation__sections">
                                                    <? foreach ($arItem["CHILD"] as $arChild): ?>
                                                        <div class="menu-navigation__sections-item<?= ($arChild['SELECTED'] ? " active" : ""); ?>">
                                                            ...
                                                            <a style="background-image: url('<?= $image; ?>');"
                                                                    href="<?= $arChild['LINK'] ?>"
                                                                    class="<?=$bShowImg?'change-color ':''?>menu-navigation__sections-item-link font_xs <?= ($arChild["SELECTED"] ? "colored_theme_text" : "dark_link") ?> <?= ($bShowImg ? " menu-navigation__sections-item-link--image" : ""); ?><?= ($arChild['CHILD'] ? " menu-navigation__sections-item-dropdown" : ""); ?>"
                                                            >
                                                                <?/* if ($arChild['CHILD']): ?>
                                                                    ...
                                                                    <span class="image colored_theme_svg ">
                                                                        ...
                                                                        <? else: ?>
                                                                            <img class="lazy" data-src="<?= $image; ?>"
                                                                                 src="<?= \Aspro\Functions\CAsproMax::showBlankImg($image); ?>"
                                                                                 alt="<?= $arChild["NAME"]; ?>"
                                                                                 title="<?= $arChild["NAME"] ?>"/>
                                                                        <? endif; ?>
																		</span>
