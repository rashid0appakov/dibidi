	...
	<div class="content_wrapper_block <?=$templateName;?>">
		<div class="maxwidth-theme only-on-front">
			...
			<div class="item-views tizers <?=$arParams['TYPE_IMG'];?>">
						<?if($arParams['DISPLAY_NAME']=='N'):?><b class="h4">Банки партнеров:</b><?endif;?>
...
<?if($arParams['DISPLAY_NAME']=='Y'):?>
									...
									<?else:?>
										<?$img = CFile::ResizeImageGet($bImage, array('width' => 160, 'height' => 160), BX_RESIZE_IMAGE_PROPORTIONAL_ALT , true);?>
<?endif;?>
									<div class="<?=$arParams['DISPLAY_NAME']=='Y'?'image':'imageN'?> shine<?=($arItem['PROPERTIES']['COLORED']['VALUE'] == 'Y' ? ' colored_theme_svg' : '');?><?=($arParams['TYPE_IMG'] !== 'top' ? ' pull-'.$arParams['TYPE_IMG'] : '');?>">
											<?if($bDetailLink):?>
