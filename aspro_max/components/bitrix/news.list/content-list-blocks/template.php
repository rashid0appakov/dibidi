...
<? if($arResult['ITEMS']): ?>
	...
	<? if(!$isAjax): ?>
		...
		?>
	<div class="item-views <?= implode(' ', $itemViewsClassList); ?>">
		<?
			$bHasSection = false;
		...
		<? if($bHasSection): ?>
			...
			?>
			<div class="section <?= $templateName.'__section'; ?>" id="<?=$this->GetEditAreaId($arResult['SECTIONS'][$arParams['PARENT_SECTION']]['ID'])?>">
		<? endif; ?>
