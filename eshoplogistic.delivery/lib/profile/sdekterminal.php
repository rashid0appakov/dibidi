...
class SdekTerminal extends Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'sdek.png';
    protected static $isProfile = true;
    protected static $service = 'sdek';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:sdek_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SDEK_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SDEK_TERMINAL_CLASS_DESCRIPTION");
    }
