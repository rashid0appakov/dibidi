...
class ImlDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:iml_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_IML_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_IML_DOOR_CLASS_DESCRIPTION");
    }
