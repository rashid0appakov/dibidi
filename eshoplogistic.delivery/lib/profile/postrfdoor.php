...
class PostrfDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'postrf.png';
    protected static $isProfile = true;
    protected static $service = 'postrf';
    protected static $type = 'door';
    protected static $profileCode = 'eslogistic:postrf_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_POSTRF_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_POSTRF_DOOR_CLASS_DESCRIPTION");
    }
