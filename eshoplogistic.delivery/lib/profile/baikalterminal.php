...
class BaikalTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:baikal_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BAIKAL_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BAIKAL_TERMINAL_CLASS_DESCRIPTION");
    }
