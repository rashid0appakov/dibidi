...
class PecomDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:pecom_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PECOM_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PECOM_DOOR_CLASS_DESCRIPTION");
    }
