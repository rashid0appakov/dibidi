...
class GtdTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'gtd.png';
    protected static $isProfile = true;
    protected static $service = 'gtd';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:gtd_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GTD_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GTD_TERMINAL_CLASS_DESCRIPTION");
    }
