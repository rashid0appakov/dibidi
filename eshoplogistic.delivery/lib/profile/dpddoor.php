...
class DpdDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:dpd_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DPD_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DPD_DOOR_CLASS_DESCRIPTION");
    }
