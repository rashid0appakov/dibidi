...
class DpdTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'dpd.png';
    protected static $isProfile = true;
    protected static $service = 'dpd';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:dpd_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DPD_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DPD_TERMINAL_CLASS_DESCRIPTION");
    }
