...
class DellineDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:delline_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DELLINE_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DELLINE_DOOR_CLASS_DESCRIPTION");
    }
