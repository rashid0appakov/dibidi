...
class PecomTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'pek.png';
    protected static $isProfile = true;
    protected static $service = 'pecom';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:pecom_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PECOM_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_PECOM_TERMINAL_CLASS_DESCRIPTION");
    }
