...
class SdekDoor extends Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:sdek_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SDEK_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_SDEK_DOOR_CLASS_DESCRIPTION");
    }
