...
class GtdDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:gtd_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GTD_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_GTD_DOOR_CLASS_DESCRIPTION");
    }
