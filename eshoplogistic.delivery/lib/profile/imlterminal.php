...
class ImlTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'iml.png';
    protected static $isProfile = true;
    protected static $service = 'iml';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:iml_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_IML_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_IML_TERMINAL_CLASS_DESCRIPTION");
    }
