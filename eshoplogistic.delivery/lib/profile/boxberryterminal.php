...
class BoxberryTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'boxberry.png';
    protected static $isProfile = true;
    protected static $service = 'boxberry';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:boxberry_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BOXBERRY_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BOXBERRY_TERMINAL_CLASS_DESCRIPTION");
    }
