...
class DellineTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'dl.jpg';
    protected static $isProfile = true;
    protected static $service = 'delline';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:delline_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DELLINE_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DELLINE_TERMINAL_CLASS_DESCRIPTION");
    }
