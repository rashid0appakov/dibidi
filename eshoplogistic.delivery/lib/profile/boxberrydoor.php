...
class BoxberryDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:boxberry_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BOXBERRY_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_BOXBERRY_DOOR_CLASS_DESCRIPTION");
    }
