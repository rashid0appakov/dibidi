...
class CustomDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected static $isProfile = true;
    protected static $service = 'custom';
    protected static $type = 'door';
    protected static $profileCode = 'eslogistic:custom_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_CUSTOM_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_CUSTOM_DOOR_CLASS_DESCRIPTION");
    }
