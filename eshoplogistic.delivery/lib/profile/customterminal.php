...
class CustomTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected static $isProfile = true;
    protected static $service = 'custom';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:custom_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_CUSTOM_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_CUSTOM_TERMINAL_CLASS_DESCRIPTION");
    }
