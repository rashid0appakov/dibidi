...
new MutationObserver(mutationRecords=>
  {
    if(mutationRecords[0]["removedNodes"][0]["data"] &&
      mutationRecords[0]["addedNodes"][0]["data"] &&
      mutationRecords[0]["removedNodes"][0]["data"] != mutationRecords[0]["addedNodes"][0]["data"] &&
      (window.b_title == undefined || mutationRecords[0]["removedNodes"][0]["data"].indexOf(window.b_title) !== -1)) {

        sku = $(".sku_props .list_values_wrapper .active");
        if(sku.length > 0 && window.b_title == undefined) {
          window.b_title = mutationRecords[0]["removedNodes"][0]["data"];
          document.title = window.b_title + " (" + sku.attr("title").split(": ")[1] + ")";
        } else if(sku.length > 0) {
          document.title = window.b_title + " (" + sku.attr("title").split(": ")[1] + ")";
        } else {
        
          window.b_title = mutationRecords[0]["removedNodes"][0]["data"];
          document.title = mutationRecords[0]["removedNodes"][0]["data"];
        }
