...
<div class="js-sku-config"
     data-params='<?= str_replace('\'', '"', CUtil::PhpToJSObject($arResult['SKU_CONFIG'], false)) ?>'></div><? endif; ?>
...
$dopClassQuant='';
if($arResult['PROPERTIES']['ZAKAZ']['VALUE_XML_ID']=='Y'){
    $dopClassQuant='change_to_order';
}else{
    $dopClassQuant='';
}
if ($showCustomOffer && isset($arResult['OFFERS'][$arResult['OFFERS_SELECTED']])) {
    ...
    $templateData['QUANTITY_DATA'] = $arQuantityData = CMax::GetQuantityArray($totalCount, array('ID' => $arCurrentSKU["ID"]), ($arParams["USE_STORE"] == "Y" && $arResult["STORES_COUNT"] && $arResult['CATALOG_TYPE'] != CCatalogProduct::TYPE_SET ? "Y" : "N"),false,$dopClassQuant);
} else {
    $templateData['TOTAL_COUNT'] = $totalCount = CMax::GetTotalCount($arResult, $arParams);
    $templateData['QUANTITY_DATA'] = $arQuantityData = CMax::GetQuantityArray($totalCount, $arItemIDs["ALL_ITEM_IDS"], ($arParams["USE_STORE"] == "Y" && $arResult["STORES_COUNT"] && $arResult['CATALOG_TYPE'] != CCatalogProduct::TYPE_SET && (!$arResult["OFFERS"] || ($arResult["OFFERS"] && $arParams["TYPE_SKU"] != "N")) ? "Y" : "N"),false,$dopClassQuant);
}
        ...
        <div class="product-info <?= (!$showCustomOffer ? "noffer" : ""); ?> product-info--type2"
                            ...
                            <div class="product-detail-gallery__thmb-inner<?= ($bVertical ? ' vertical' : ''); ?>">
                                ...
                                <? if ($popupVideo): ?>
                                    <div class="video-block popup_video <?= ($countPhoto > 3 ? 'fromtop' : ''); ?> sm">
                                        <a class="various video_link image dark_link" href="<?= $popupVideo; ?>"
                                        ...
                                        <div class="product-info-headnote__article">
                                            <div class="article muted font_xs" itemprop="additionalProperty" itemscope
                                                ...
                                                <span class="article__title"
                                                      itemprop="name"><?= $article["NAME"]; ?>:</span>
                                                <span class="article__value"
                                                      itemprop="value"><?= $article["VALUE"] ?></span>
                                            </div>
                                        </div>
                                    <? endif; ?>
                    ...
                    <div class="flexbox flexbox--row flex-wrap align-items-normal <?= !$bShowPropsBlock ? 'justify-center' : '' ?>">
                        ...
                        <div class="product-action flex-50">
                            <div class="info_item">
                                                        ...
                                                        <? if (isset($arResult['PRICE_MATRIX']) && $arResult['PRICE_MATRIX']): // USE_PRICE_COUNT?>
                                                            ...
                                                            <div class="" itemprop="offers" itemscope
                                                                ...
                                                                <link itemprop="availability"
                                                                      href="http://schema.org/<?= ($arResult['PRICE_MATRIX']['AVAILABLE'] == 'Y'&&$arResult['PROPERTIES']['ZAKAZ']['VALUE_XML_ID']!='Y'? 'InStock' : 'OutOfStock') ?>"/>
                                                                <?
                                                    ...
                                                    <? if ($arParams["SHOW_CHEAPER_FORM"] == "Y"): ?>
                                                        <div class="cheaper_form muted777 font_sxs">
                                                            ...
                                                            <span class="animate-load dotted" data-event="jqm"
                                                                  ...
                                                                  data-autoload-product_id="<?= $arCurrentSKU ? $arCurrentSKU['ID'] : $arResult['ID']; ?>"><?= ($arParams["CHEAPER_FORM_NAME"] ? $arParams["CHEAPER_FORM_NAME"] : Loc::getMessage("CHEAPER")); ?></span>
                                                        </div>
                                                    <? endif; ?>
                                                </div>
                                            </div>
                                            <div class="bonus_programm">
                                                <div class="price_bonus h5">
                                                    + <span><?= CCurrencyLang::CurrencyFormat($arItemPrices['VALUE'] / 100, $arResult['MIN_PRICE']['CURRENCY']) ?></span>
                                                    бонусов
                                                </div>
                                                <div class="link_bonus h5">
                                                    <a href="/sale/nakopitelnaya_bonusnaya_sistema_skidok_dlya_podpischikov_nashikh_sotsialnykh_setey/">По бонусной программе</a>
                                                </div>
                                                    ...
                                                    <div class="offer_buy_block buys_wrapp">
                                                        <div class="counter_wrapp big clearfix">
                                                            ...
                                                            <div id="<?= $arItemIDs["ALL_ITEM_IDS"]['BASKET_ACTIONS']; ?>"
                                                                 class="button_block <?= ($arAddToBasketData["ACTION"] == "ORDER" || !$arAddToBasketData["CAN_BUY"] || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] || $arAddToBasketData["ACTION"] == "SUBSCRIBE" ? "wide" : ""); ?>">
                                                                <!--noindex-->
                                                                <?= $arAddToBasketData["HTML"] ?>
                                                                <!--/noindex-->
                                                            </div>
                                ...
                                <? //help text?>
                                <? if ($arResult['HELP_TEXT']&&empty($arResult['PROPERTIES']['TIMING']['VALUE']['TEXT'])&&$arResult['PROPERTIES']['ZAKAZ']['VALUE_XML_ID']!='Y'): ?>
                                    <div class="text-form">
                                ...
                                <? else: ?>
                                    <div class="text-form">
                                        <div class="price_txt muted777 font_sxs muted ncolor">
                                            <?= CMax::showIconSvg("info_big pull-left", SITE_TEMPLATE_PATH . '/images/svg/catalog/info_big.svg', '', '', true, false); ?>
                                            <div class="text-form-info">
                                                <?=$arResult['PROPERTIES']['TIMING']['~VALUE']['TEXT']?>
                                            </div>
                                        </div>
                                    </div>
                                <?endif;?>
            ...
            <? if ($arResult['OFFERS']): ?>
				...
				<? foreach ($arResult['OFFERS'] as $arOffer): ?>
                    ...
                    <span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
						...
						<link itemprop="availability"
                              href="http://schema.org/<?= ($arOffer['CAN_BUY']&&$arResult['PROPERTIES']['ZAKAZ']['VALUE_XML_ID']!='Y' ? 'InStock' : 'OutOfStock') ?>"/>
						<?
                        if ($arDiscount["ACTIVE_TO"]) {
                            ?>
                            <meta itemprop="priceValidUntil"
            ...
            <? else: ?>
                <? if (!$bPriceCount): ?>
					...
					<meta itemprop="priceCurrency" content="<?= $arResult['MIN_PRICE']['CURRENCY'] ?>"/>
					<link itemprop="availability"
                          href="http://schema.org/<?= ($arResult['MIN_PRICE']['CAN_BUY']&&$arResult['PROPERTIES']['ZAKAZ']['VALUE_XML_ID']!='Y' ? 'InStock' : 'OutOfStock') ?>"/>
					<?
                    if ($arDiscount["ACTIVE_TO"]) {
                        ?>
                        <meta itemprop="priceValidUntil"
...
<? if (($arResult['DISPLAY_PROPERTIES'] || $arResult['OFFER_PROP']) && ($iCountProps > $arParams['VISIBLE_PROP_COUNT'])): ?>
    ...
    <? else: ?>
        <? if ($arParams["PROPERTIES_DISPLAY_TYPE"] != "TABLE"): ?>
            <div class="props_block js-scrolled clearfix flexbox row js-offers-prop"
                 id="<? echo $arItemIDs["ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>">
                <? foreach ($arResult["DISPLAY_PROPERTIES"] as $propCode => $arProp): ?>
                    <div class="char js-prop-replace col-lg-3 col-md-4 col-xs-6 bordered" itemprop="additionalProperty"
                         itemscope itemtype="http://schema.org/PropertyValue">
                        <div class="char_name">
                            <div class="props_item muted js-prop-title <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>whint<? } ?>">
                ...
                <? foreach ($arResult['OFFER_PROP'] as $propCode => $arProp): ?>
                    <div class="char js-prop col-lg-3 col-md-4 col-xs-6 bordered" itemprop="additionalProperty"
                         itemscope itemtype="http://schema.org/PropertyValue">
                        <div class="char_name">
                            <div class="props_item muted js-prop-title <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>whint<? } ?>">
                                <span itemprop="name"><?= $arProp["NAME"] ?></span>
